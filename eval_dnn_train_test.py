...
def load_and_preprocess(base_dir, model_name, class_names):
...
def main():
    ...
    model = DNNMultiClass(input_dim, num_classes)
    ...
    # 数据预处理
    X_test, y_test, feature_cols = load_and_preprocess(base_dir, model_name, class_names)
